...
- Подключите базу данных (инструкции даны ниже)
...
* Заполните БД, запустив скрипт
```
$ python manage.py shell
>>> from pokemon_entities.tools import load_pokemons
>>> load_pokemons()
```
Скрипт заполнит базу из фала pokemons.json
* Дозаполните базу через адинку

2. Подключение готовой базы
* Положите базу данных в корень проекта (структура базы данных должна соответсовать модели)
* Если имя базы данных отличается от db.sqlite3, сделайте соответствующие изменения в settings.py
